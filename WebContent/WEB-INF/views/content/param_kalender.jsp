<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Maintenance Kalender</h1>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">Maintenance Kalender</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="card card-warning">
						...
						<div class="card-header">
							<h3 class="card-title" id="create">Create Kalender</h3>
						...
						<div class="card-body">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-10">
										<input type="date" data-date-format="DD MMMM YYYY" id="user_name" class="form-control"
								...
								<div class="row">
									...
									<div class="col-md-10">
										<input type="text" id="user_name" class="form-control"
											placeholder="Masukan Nama Libur" required>
									</div>
								</div>
							</div>
							<!-- text input -->
